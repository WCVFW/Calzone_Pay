...
const PageStyles = () => (
  <style>{`
    .page-header-section { background: linear-gradient(to right, #f2709c, #ff9472); color: white; padding: 60px 0; text-align: center; }
...
const GasPage: React.FC = () => {
  ...
  const faqData = [
    { q: "Where can I find my Customer ID?", a: "Your Customer ID is usually mentioned on your previous gas bills, either at the top or in the account summary section." },
    { q: "How long does it take for the payment to be processed?", a: "Payments are typically processed within 24-48 hours. You will receive an instant confirmation from us." },
  ];
    ...
    <>
      ...
      <section className="page-header-section">
        <div className="container">
          <h1 className="display-5 fw-bold">Piped Gas Bill Payment</h1>
          <p className="lead">Pay your gas bills online quickly and conveniently.</p>
        </div>
      </section>

      <div className="container">
        <section className="form-section">
          <h3 className="text-center mb-4">Pay Your Gas Bill</h3>
          <form>
            <div className="row g-3">
              <div className="col-12">
                ...
                <select id="operator" className="form-select form-select-lg">
                  <option selected>Select your gas provider...</option>
              ...
              <div className="col-12">
                <label htmlFor="customerId" className="form-label">Customer ID / BP Number</label>
                <input type="text" className="form-control form-control-lg" id="customerId" placeholder="Enter your Customer ID" />
              </div>
